...
* DONE Open Questions
  ...
  - [ ] Should protected resources of EIDA-RS implement both HTTP POST and
    GET methods? If using clients make use of the HTTP GET method it should
    be emphazized that access tokens might be logged.
...
*** DONE Design and Security Considerations
  ...
  - When registering a protected request session with EIDA-AS, the protected
    ...
    Especially, this design may be useful in a chained EIDA-GRS environment.
